...
public class BuilderComparatorDemo {
	...
	BuilderComparatorDemo(String name, int gstNumber, int totalCompletedProjects, int reveune){
	...
	public String toString() {
		return name + "-" + revenue + "-" + totalCompletedProjects;
	}
}
