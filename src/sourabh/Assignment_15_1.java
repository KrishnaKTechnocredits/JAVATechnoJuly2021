...
public class Assignment_15_1 {              // difference of even length name sum and odd length name sum
	...
	public static void main(String[] args) {
		...
		System.out.println("Difference of even length name and odd lenght name : "+assignment_15_1.takeStringArray(arr));
	}
}
