...
public class Assignment_19 {
	...
	public static void main(String[] args) {
		Assignment_19 stringProgramsBasedOnScannerClass = new Assignment_19();
 ...
 * "Hi Techno Credits Hello" output : 4 program 2: Find maximum word length from
 * given statement. input = "good morning technocredits hi hello" output :
 * technocredits program 3 : Find minimum word length from given statement.
 * input = "good morning technocredits hi hello" output : hi program 4: sum of
 * all numbers in given statement. input = "10 10 20 30"; output : 70
 */
