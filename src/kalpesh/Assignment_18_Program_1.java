...
/*
 * Program 1 : Reverse all elements of an array at same position String[] input
 * = {"madhvi", "surbhi", "neha", "sandesh", "ankit", "vaibhav"}; output :
 * [ivhdam, ihbrus, ahen, hsednas, tikna, vahbiav]
 * 
 * Note : you can print array content directly using
 * sop(Arrays.toString(output)); toString() method of Arrays class return
 * String.
 * 
