...
public class Assignment15 {
	...
	public static void main(String[] args) {
		...
		Assignment15 diff = new Assignment15();
		System.out.println("Difference of even length name and odd lenght name : " + diff.takeStringArray(arr));
	}
}

/*
 * *program 1*: wap that will return difference of even length name sum and odd
 * lenght name sum. arr[0] = "Maulik"; arr[1] = "Techno"; arr[2] = "Nidhi";
 * arr[3] = "Ankit"; output : 2
 */