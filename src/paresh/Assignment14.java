...
public class Assignment14 {
	...
	int getMaximumxAndMinimumNumberDiffrence(int[] num) {
		int min = num[0];
		int max = 0;
		for (int index = 0; index < num.length; index++) {
			if (num[index] < min)
	...
	public static void main(String[] args) {
		...
		System.out.println("Difference between max and min number from given array: " +assignment14.getMaximumxAndMinimumNumberDiffrence(input));
