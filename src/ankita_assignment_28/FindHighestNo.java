...
public class FindHighestNo {
		...
		public static void main(String[] args) {
			FindHighestNo findHighestNumber = new FindHighestNo();
			int[] arr = { 10, 23, 2, 11, 55, 43, 99 };
			System.out.println("2nd max number of input Array:" + findHighestNumber.secondHighestNumber(arr));
