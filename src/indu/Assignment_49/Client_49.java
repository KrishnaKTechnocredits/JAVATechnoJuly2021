...
public class Client_49 {
	...
	public static void main(String[] args) {
		Builder b1 = new Builder("Indu","ABZ12398IN",11,9000000); 
		Builder b2 = new Builder("Indu","ABZ12398IN",11,9000000); 
		Builder b3 = new Builder("Bhartiya","AHGG145IC",16,1000000); 
