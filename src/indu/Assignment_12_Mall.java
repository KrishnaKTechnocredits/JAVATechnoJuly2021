...
{	
	...
	boolean needCarryBags(boolean status)
	{
		if(status)
		{
			...
			System.out.println("Great " + custName + " Say no to plastic.");
		return false;
	}
   ...
   public static void main(String[] as)
   {
	   ...
	   mall_1.setCustomerDetails("Nikki");
	   mall_1.itemsAddedToCart(20);
	   ...
	   mall_2.setCustomerDetails("Tejal");
	   mall_2.itemsAddedToCart(20);
	   ...
	   mall_3.setCustomerDetails("Indu");
