...
public class Ass13countofzeros{
	
	void countofzeros(int[] inputarr) {
		int count = 0; 
		for (int index = 0 ; index < inputarr.length ; index++) {
			if (inputarr[index] == 0)
				count++;
		}
		System.out.println("Count of Zeros in the given Array : " + count);
		
	}

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ass13countofzeros ass13countofzeros = new Ass13countofzeros();
		int[] inputarr = {1,-11,0,0,55,0,-23,0};
		ass13countofzeros.countofzeros(inputarr);
	}
