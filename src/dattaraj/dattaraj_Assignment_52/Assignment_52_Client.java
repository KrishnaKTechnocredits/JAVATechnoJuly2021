...
public class Assignment_52_Client {
	...
	public static void main(String[] args) {
		...
		Assignment_52_Employee emp2 = new Assignment_52_Employee(3, "Dattaraj", 800000, 8);
		Assignment_52_Employee emp3 = new Assignment_52_Employee(4, "Vivek", 150000, 4);
		Assignment_52_Employee emp4 = new Assignment_52_Employee(2, "Dattaraj", 650000, 2);
		Assignment_52_Employee emp5 = new Assignment_52_Employee(5, "Dattaraj", 50000, 3);
