package dattaraj.dattaraj_Assignmnet_51;
...
public class Assignment_51_Client {
	...
	public static void main(String[] args) {
		...
		Assignment_51_Builder b2 = new Assignment_51_Builder("Samiksha", 2, 2, 20000);
		Assignment_51_Builder b3 = new Assignment_51_Builder("Dattaraj", 3, 4, 95000);
		Assignment_51_Builder b4 = new Assignment_51_Builder("Akansha", 4, 3, 50000);
		Assignment_51_Builder b5 = new Assignment_51_Builder("Yogesh", 5, 1, 90000);
