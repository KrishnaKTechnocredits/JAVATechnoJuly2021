...
public class Assignment34_P2 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		int[] input = {1,3,4,5,7,3,9,10,11,14,44,67,1,2,3,99};
		Assignment34_P2 p2 = new Assignment34_P2();
		p2.addSumAfterTripleSeq(input);
	}
	...
	void addSumAfterTripleSeq(int[] arr) {
		// TODO Auto-generated method stub
    	...
    	System.out.println("adding sum after triplets output array is as :" +Arrays.toString(output));
	}
