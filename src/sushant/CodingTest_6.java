...
public class CodingTest_6 {
	...
	public static void main(String[] args) {
		...
		System.out.println( "First non repeating character of "+input+" is "+codingTest_6.firstNonRepeatingChar(input));

		System.out.println("Enter the String : ");
		String[] arr = scan.nextLine().split(" ");
		System.out.println( "First non repeating word is "+codingTest_6.firstNonRepeatingWord(arr));
