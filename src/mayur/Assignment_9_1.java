...
public class Assignment_9_1 {
	...
	public static void main(String[] args) {
		...
		Assignment_9_1 assignment_9_1 = new Assignment_9_1();
		assignment_9_1.setQuantity(50, 43, 39, 43, 0);
		assignment_9_1.getOrderDetails(50, 10, 10, 44, 78);

		System.out.println("------Product which are in stock --------- ");
		// assignment_9.getOrderDetails(40,10);
		assignment_9_1.availableStock();
