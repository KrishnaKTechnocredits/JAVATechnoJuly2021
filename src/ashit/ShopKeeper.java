...
public class ShopKeeper {
	...
	void demandProduct(int demandmaggiepacket, int demanddosapacket, int demandoilpacket, int demandpanipuripacket, int demandmasalpacket){
		...
		System.out.println("*************** Panipuri Packets *************8");
	...
	public static void main(String[] args) {
		...
		shopkeeper.setIntialquantity(45,42,28,46,90);
		shopkeeper.demandProduct(30,55,28,50,65);
		shopkeeper.availableStockofProduct();
		shopkeeper.outOfStockProduct();
	}
