...
public class Assignment_30_1_reverseNumber {
	...
	public static void main(String[] args) {
		Assignment_30_1_reverseNumber revrese= new Assignment_30_1_reverseNumber();
		revrese.reverseNumber(12345);
		revrese.reverseNumber(10089);
	}
