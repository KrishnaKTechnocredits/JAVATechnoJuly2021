...
public class Assignment_30_3_Palindromeumber {
	
	void checkPalindromeumber(int num) {
		int revNum=0;
		int number=num;
		while (number>0) {
	...
	public static void main(String[] args) {
		 Assignment_30_3_Palindromeumber obj= new  Assignment_30_3_Palindromeumber();
		 obj.checkPalindromeumber(127821);
		 obj.checkPalindromeumber(353);
		 obj.checkPalindromeumber(2332);
