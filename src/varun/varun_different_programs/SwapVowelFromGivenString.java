...
public class SwapVowelFromGivenString {
	...
	public static void main(String[] args) {
		...
		SwapVowelFromGivenString.getSwapVowel(str1);
		System.out.println("String after swapping vowel position: ");
		SwapVowelFromGivenString.getSwapVowel(str2);
		System.out.println("String after swapping vowel position: ");
		SwapVowelFromGivenString.getSwapVowel(str3);
	}
}