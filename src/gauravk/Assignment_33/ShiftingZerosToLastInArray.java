 ...
 */
public class ShiftingZerosToLastInArray {
	
	public ShiftingZerosToLastInArray(int[] arr) {
		...
		System.out.println("Shifting zeros to last for array "+Arrays.toString(arr)+"\nOutput: "+Arrays.toString(output));
	}
	
	public static void main(String[] args) {
		int[] input = {1,0,3,4,0,2,88,0,0,22,34};
		new ShiftingZerosToLastInArray(input);
	}
}
