 ...
 */
public class ShiftingNegativeToBeginingAndPositiveLast {
	
	public ShiftingNegativeToBeginingAndPositiveLast(int[] arr) {
	...
	public static void main(String[] args) {
		...
		new ShiftingNegativeToBeginingAndPositiveLast(input);
	}
}