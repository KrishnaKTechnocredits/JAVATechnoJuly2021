...
public class Assignment45 {
	...
	public static void main(String[] args) {
		...
		Assignment45.removeDuplicateElements(input);
		Assignment45.printDuplicateElements(input);
		...
		Assignment45.printAllOccurancesOfParticularElement(input, "Akanksha");
		...
		Assignment45.printNameStartWithALengthGreaterThan6(input);
