package amol_Pawar.assignment_23;
...
public class Assignment_23 {
	...
	public static void main(String[] args) {
		...
		assignment_23.setBalance(300, 300, 300, 300);
		assignment_23.getAllCreditAndDebitOpration("hdfC", "creDit", 100);
		assignment_23.getAllCreditAndDebitOpration("hdfC", "creDit", 200);
		assignment_23.getAllCreditAndDebitOpration("icici", "Credit", 200);
		assignment_23.getAllCreditAndDebitOpration("icici", "Credit", 500);
		assignment_23.getAllCreditAndDebitOpration("Sbi", "Credit", 100);
		assignment_23.getAllCreditAndDebitOpration("Bob", "Credit", 100);
		assignment_23.getAllCreditAndDebitOpration("Bob", "Credit", 100);
		assignment_23.getAllCreditAndDebitOpration("Bob", "Credit", 100);
		assignment_23.getAllCreditAndDebitOpration("Bob", "Credit", 100);
		assignment_23.getAllCreditAndDebitOpration("Sbi", "Credit", 100);
		...
		assignment_23.getAllCreditAndDebitOpration("Sbi", "Credit", 100);
		assignment_23.getAllCreditAndDebitOpration("Sbi", "Credit", 100);
		assignment_23.getAllCreditAndDebitOpration("hdfC", "Debit", 100);
		assignment_23.getAllCreditAndDebitOpration("hdfC", "Debit", 200);
		assignment_23.getAllCreditAndDebitOpration("icici", "debit", 200);
		assignment_23.getAllCreditAndDebitOpration("icici", "debit", 500);
		assignment_23.getAllCreditAndDebitOpration("Sbi", "debit", 100);
		assignment_23.getAllCreditAndDebitOpration("Sbi", "debit", 100);
		assignment_23.getAllCreditAndDebitOpration("BOB", "debit", 100);
		assignment_23.getAllCreditAndDebitOpration("BOb", "debit", 100);
		assignment_23.getIndividualCreditOpration();
		assignment_23.getIndividualDebitOpration();
		assignment_23.getAllOpration();
