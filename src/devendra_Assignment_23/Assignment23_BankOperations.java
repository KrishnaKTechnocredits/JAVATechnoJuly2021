package devendra_Assignment_23;

public class Assignment23_BankOperations {
	int sbiAmt = 10000;
	int hdfcAmt = 20000;
	int iciciAmt = 30000;
	int bobAmt = 40000;
	...
	public static void main(String[] args) {
		Assignment23_BankOperations bank = new Assignment23_BankOperations();
		bank.bankTransfers("ICICI", "Debit", 1000);
		bank.bankTransfers("HDFC", "Credit", 4000);
		bank.bankTransfers("SBI", "Debit", 5000);
