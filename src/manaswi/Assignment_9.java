...
public class Assignment_9 
{
	...
	void initializeCountOfItems(int initMaggieCount,int initDosaCount,int initPouches,int initPanipuri,int initMasala) 
	{
	...
	void purchaseItems(int buyMaggieCount,int buyDosaCount,int buyPouchesCount,int buyPanipuriCount,int buyMasalaCount) 
		{
	...
	public static void main(String[] args) 
	{
		...
		assignment_9.purchaseItems(35, 30, 45, 25, 60);
